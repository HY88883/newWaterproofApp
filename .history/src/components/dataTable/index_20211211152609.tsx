...
export default class DataTable extends PureComponent {
    ...
    _leftRenderRow(rowData) {
        const {customRowStyles}=this.props;
        return (
            <View style={[{...styles.leftListRow,customRowStyles?{backgroundColor:customRowStyles.jRow}:{}},rowData.index%2 && (customRowStyles?{backgroundColor:customRowStyles.oRow}:styles.tableCellBackground)]}>

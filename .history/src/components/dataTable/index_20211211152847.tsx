...
export default class DataTable extends PureComponent {
    ...
    _leftRenderRow(rowData) {
        ...
        let a={};
        return (
            <View style={[Object.assign(a,customRowStyles&&{backgroundColor:customRowStyles.jRow}),rowData.index%2 && (customRowStyles?{backgroundColor:customRowStyles.oRow}:styles.tableCellBackground)]}>

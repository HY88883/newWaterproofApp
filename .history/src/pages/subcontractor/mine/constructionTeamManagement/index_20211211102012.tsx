         ...
         return (
             ...
             <Touchable onPress={()=>handleViewDetail(item.id)} style={styles.renderItem} >
                ...
                <View style={{flexDirection:'row',alignItems: 'center'}}>
                  ...
                  <Text style={[styles.leftText,{color:'#E6C229'}]}>{item.principalUserName}</Text>
                </View>
                <View style={{flexDirection:'row',alignItems: 'center'}}>
                <Text style={styles.leftText}>队员：</Text>
                  <Text style={[styles.leftText,{color:'#D62828'}]}>{item.userCount}</Text>
                  </View>
              </View>
              <View style={{flexDirection:'row',alignItems: 'center'}}>
                <Text style={styles.leftText}>累计施工：</Text>
                  <Text style={[styles.leftText,{color:'#D62828'}]}>{item.completedConstructionAreaCount}m²</Text>
                  </View>
             </Touchable>
             </>
         );

    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        <View>
            ...
            <Text>施工部位：<Text>{constructionRecordDetail.partsName}</Text></Text>
            <Text>施工区域：<Text>{constructionRecordDetail.location}</Text></Text>
            <Text>施工工艺：<Text>{constructionRecordDetail.constructionTechnologyName}</Text></Text>
            <Text>完成面积：<Text>`${constructionRecordDetail.area===-1?0:constructionRecordDetail.area}m²`</Text></Text>
        </View>
      </View>
    </View>
  );

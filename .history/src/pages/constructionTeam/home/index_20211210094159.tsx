...
const Home = (props) => {
  ...
  const {constructionRecord:{ConstructionSummary}}=useSelector(state=>({
...
function showInfo(title){
  if(title==='本月累计工时：')return `${ConstructionSummary.thisMonthWorkingHours===-1?0:ConstructionSummary.thisMonthWorkingHours}小时`;
            ...
            <View style={styles.itemStyle} key={item.title}>
              ...
              <View style={styles.bView}>
                ...
                <View style={styles.rVeiew}>
                  <Text style={styles.infox}>{showInfo(item.title)}</Text>
                </View>
              </View>
            </View>
          ))

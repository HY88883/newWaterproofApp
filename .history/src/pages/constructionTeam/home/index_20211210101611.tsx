   ...
   <View style={styles.info}>
      ...
      <View style={styles.listView}>
        ...
        <View style={styles.itemxx}>
          <View>
            <View style={{marginBottom:px2dp(10)}}><Text style={styles.biao}>fef</Text></View>
            <View style={{flexDirection:'row',alignItems: 'center'}}>
              <Text style={[styles.leftText]}>工作内容：</Text>
              <Text style={[styles.leftText,{color:'#E6C229'}]}>wefwe</Text>
            </View>
            <View style={{flexDirection:'row',alignItems: 'center'}}>
            <Text style={styles.leftText}>清理面积：</Text>
              <Text style={[styles.leftText,{color:'#D62828'}]}>wefwe</Text>
              </View>
          </View>

          <View>
              <View style={{marginBottom:px2dp(10)}}><Text style={styles.leftText}>14:30</Text></View>
              <Touchable >

  ...
  function onFinisht(values){
    if (!files[3]) {
      ...
      const params = {
        ...
        phone: values.phone,
        idCardPositivePhotos: identityPositionId,
        idCardBackPhotos: identityOppositionId,
        idCardNumber: values.idCardNumber,
        bankCardPositivePhotos: bankcardPositionId,
        bankCardBackPhotos: bankcardOppositionId,

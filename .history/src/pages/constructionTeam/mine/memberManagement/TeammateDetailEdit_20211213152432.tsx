...
const TeammateDetailEdit = (props) => {
  ...
  return (
    ...
    {
        !isStepFinish[0]&&  <View style={{marginVertical:px2dp(12),backgroundColor:'#fff',padding:px2dp(14)}}>
        <View>
    ...
    {
        isStepFinish[0]&&!isStepFinish[1]&&  <View style={{marginVertical:px2dp(12),backgroundColor:'#fff',padding:px2dp(14)}}>
        <View>
...
<Touchable onPress={()=>hanleImage(2)}>
     ...
     {
         isStepFinish[0]&&isStepFinish[1]&&!isStepFinish[2]&& <View style={{marginVertical:px2dp(12),backgroundColor:'#fff',padding:px2dp(14)}}>
         <View>

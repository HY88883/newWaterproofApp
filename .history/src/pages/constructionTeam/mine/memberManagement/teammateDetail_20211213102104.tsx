...
const TeammateDetail = (props) => {
  ...
  const {
    ...
    let images=useMemo(()=>{
     return teamMemberDetail&&teamMemberDetail.idCardPositivePhotosAttach&&teamMemberDetail.idCardBackPhotosAttach&&teamMemberDetail.bankCardPositivePhotosAttach&&teamMemberDetail.bankCardBackPhotosAttach?  [`${Config.FILE_URL}${teamMemberDetail.avatar}`,`${Config.FILE_URL}${teamMemberDetail.idCardPositivePhotosAttach.name}`
      ,`${Config.FILE_URL}${teamMemberDetail.idCardBackPhotosAttach.name}`,
      `${Config.FILE_URL}${teamMemberDetail.bankCardPositivePhotosAttach.name}`,
      `${Config.FILE_URL}${teamMemberDetail.bankCardBackPhotosAttach.name}`,
    ]:[];
    },[]);

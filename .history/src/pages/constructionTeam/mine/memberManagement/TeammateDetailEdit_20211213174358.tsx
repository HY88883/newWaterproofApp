...
const TeammateDetailEdit = props => {
  ...
  function onFinisht(values){
      console.log('faefwf=',values);
  }
    ...
    <ScrollView style={styles.container}>
      ...
      {isStepFinish[0] && isStepFinish[1] && !isStepFinish[2] && (
        <View
          ...
          <View style={styles.imagesvv}>
            {files[4] && files[4].bankcardPositionLink ? (
              <Touchable onPress={() => hanleImage(4)}>
                <Image
                    source={{
                    uri: `${Config.FILE_URL}${files[4].bankcardPositionLink}`,
                  }}
                    style={styles.sh}
                />
              </Touchable>
            ...
            {files[5] && files[5].bankcardOppositionLink ? (
              <Touchable onPress={() => hanleImage(5)}>
                <Image
                    source={{
                    uri: `${Config.FILE_URL}${files[5].bankcardOppositionLink}`,
                  }}
                    style={styles.sh}
                />
              </Touchable>

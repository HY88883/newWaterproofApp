        ...
        if(r.success){    
         ...
         if(data.teamId)   setTeamId(data.teamId)
                ...
                files[4] = {
                  ...
                  setFiles([...files]);
                if(insuranceCertificateAttachList&&insuranceCertificateAttachList.length>0){
                  setUploadFileList(insuranceCertificateAttachList)  
        }
      });
    }
  },[]);
              ...
              <View>
                {
                  uploadFileList&&uploadFileList.length>0&&uploadFileList.map((item,index)=>(
                    <Touchable style={{width:px2dp(220)}} key={item.attachId}
                    >

...
import {Text, View, StyleSheet, ScrollView, TextInput, PermissionsAndroid, Platform, Image} from 'react-native';
       ...
       {/*    <ImagePicker
        ...
        /> */}
         ...
         <Touchable onPress={()=>hanleImage(0)}>
            <Image
                source={{uri: `${Config.FILE_URL}${avatarLink}`}}
                style={styles.images}
      />
         </Touchable>:
      <Touchable style={styles.images} onPress={()=>hanleImage(0)}/>
        }

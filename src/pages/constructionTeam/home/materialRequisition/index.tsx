...
//物料申请
class MaterialRequisition extends React.Component<any> {
  state={
    isSubmitting:false,
    projectItem:{},
    tableData:[[null,null,'']],
  ...
  handleSubmit=async ()=>{
    ...
    const params={materialApplicationDetailList:this.materialList,projectId:this.state.projectItem.id,
      teamId:this.user.deptId};
...
export default connector(MaterialRequisition);

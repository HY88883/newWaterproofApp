   ...
   <View style={styles.info}>
      {
        ...
        <Touchable onPress={()=>handleOnPress(_i)} key={item.title} style={{alignItems:'center'}}>
      ...
      <View style={styles.listView}>
        <View style={styles.listViewheader}>
         ...
         <ScrollView style={styles.list}>
         {
          ...
          {
            list&&list.length===0&&<View style={{alignSelf: 'center',marginTop:8}}>
              <Text style={customStyles.text}>今日暂无施工日志</Text>
            </View>
          }
         </ScrollView>
